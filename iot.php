...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
			...
			<div class="interior-page">
				...
				<h1 style="font-weight: 500;">An Internet Of Things</h1>
				<p style="font-style: italic;font-weight:400;text-align: center;width: 75%;margin: 0 auto 2em auto;">"In the interconnected world of the future, everything that can connect to the Internet and share meaningful information about itself, will."</p>

				<div class="newspaper">

					<h2 style="margin-top: 0;">Today's Internet</h2>
